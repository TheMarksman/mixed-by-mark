...
<table>
    ...
    <tr>
        <td>{% post_link GuinnessBeefSliders Guinness Beef Sliders %}</td>
        <td>15 minutes</td>
        <td>Roast beef, Guinness, Swiss cheese, Cheddar cheese</td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        <td>{% post_link CaramelAppleTreats Caramel Apple Treats %}</td>
        <td>5 minutes</td>
        <td>Rolos, Apple, Pretzels</td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        <td>{% post_link DarkChocolateCupcakes Dark Chocolate Cupcakes %}</td>
        <td>15-18 minutes</td>
        <td>Dark chocolate chips, Dark cocoa powder, Coffee</td>
    </tr>
    <tr>
